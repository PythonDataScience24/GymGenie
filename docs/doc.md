...
<pre> python .\src\main_cli.py </pre>
...
Menu Option:
1. Log Workout - click on the workout button
2. Goal - click on set a goal
3. See Goals Progress - click on see progress option
4. Summary Workouts - click on see workouts option
